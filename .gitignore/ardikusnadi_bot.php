...
{
    global 589095795;
    return "https://api.telegram.org/bot" . 589095795 . "/". $method;
}
...
function create_response($text, $message)
{
   ...
   // identifikasi perintah (yakni kata pertama, atau array pertamanya)
    switch ($command[0]) {
        ...
        case '/id':
        case '/id'.@ardikusnadi_bot : //dipakai jika di grup yang haru ditambahkan @usernamebot
            $hasil = "$namauser, ID kamu adalah $fromid";
            break;
        
        // jika ada permintaan waktu
        case '/time':
        case '/time'.@ardikusnadi_bot :
